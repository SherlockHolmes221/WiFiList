...
public class WiFiSessionManager {
    ...
    private static WiFiSessionManager manager;
     ...
     * @return
     */
    public static WiFiSessionManager getInstance(Context context) {
        if (manager == null) {
            synchronized (WiFiSessionManager.class) {
                manager = new WiFiSessionManager(context);
            }
        }
        return manager;
    }
    ...
    // 构造器
    private WiFiSessionManager(Context context) {
        // 取得WifiManager对象
