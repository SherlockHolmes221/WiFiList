...
public class WiFiSessionManager_old {
    // 定义WifiManager对象
    ...
    private static WiFiSessionManager_old manager;

    private static final String TAG = "WiFiSessionManager_old";
     ...
     * @return
     */
    public static WiFiSessionManager_old getInstance(Context context) {
        if (manager == null) {
            synchronized (WiFiSessionManager_old.class) {
                manager = new WiFiSessionManager_old(context);
            }
        }
        return manager;
    }
    ...
    // 构造器
    private WiFiSessionManager_old(Context context) {
        // 取得WifiManager对象
    ...
    public void startScan() {
        ...
        Log.i(TAG, "results.size:"+ mWifiList.size());
        // 得到配置好的网络连接
